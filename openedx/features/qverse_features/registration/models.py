...
from openedx.features.qverse_features.registration.validators import (validate_file_extension,
...
MAX_LEVEL_CHOICES = 8
LEVEL_CHOICES = ((i, ugettext_noop('Year ' + str(i))) for i in range(1, MAX_LEVEL_CHOICES))
...
class QVerseUserProfile(models.Model):
    ...
    current_level = models.IntegerField(choices=LEVEL_CHOICES, validators=[validate_current_level])
