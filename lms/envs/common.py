...
EDLY_ROLES = {
    'panel_restricted': EDLY_PANEL_RESTRICTED_USERS,
    'panel_user': EDLY_PANEL_USERS_GROUP_NAME,
    'panel_admin': EDLY_PANEL_ADMIN_USERS_GROUP_NAME,
    'subscriber': WORDPRESS_SUBSCRIBER_USERS_GROUP_NAME,
    'edly_admin': WORDPRESS_EDLY_ADMIN_USERS_GROUP_NAME
}

EDLY_ROLES_LIST = [
    EDLY_PANEL_RESTRICTED_USERS,
    EDLY_PANEL_USERS_GROUP_NAME,
    EDLY_PANEL_ADMIN_USERS_GROUP_NAME,
    WORDPRESS_SUBSCRIBER_USERS_GROUP_NAME,
    WORDPRESS_EDLY_ADMIN_USERS_GROUP_NAME
]
